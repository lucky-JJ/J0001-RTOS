...
with open("./Pin/GPIO.c", 'w') as fp:
	...
	fp.write('    {\n')
	fp.write('		if(config[i].base == GPIOA)\n')
	fp.write('		{\n')
	fp.write('			__HAL_RCC_GPIOA_CLK_ENABLE();\n')
	fp.write('		}\n')
	fp.write('		else if(config[i].base == GPIOB)\n')
	fp.write('		{\n')
	fp.write('			__HAL_RCC_GPIOB_CLK_ENABLE();\n')
	fp.write('		}\n')
	fp.write('		else if(config[i].base == GPIOC)\n')
	fp.write('		{\n')
	fp.write('			__HAL_RCC_GPIOC_CLK_ENABLE();\n')
	fp.write('		}\n')
	fp.write('		else if(config[i].base == GPIOH)\n')
	fp.write('		{\n')
